...
- [8. Where is your Personal Information stored and processed?]()
- [9. How long do we keep your Personal Information?]()
- [10. How do we secure your Personal Information?]()
- [11. What about the privacy of children?]()
...
||If you want us to sync the photos on your device for food-related photos|- The Tassie Service can access and collect images stored in your device's photo storage for uploading the thumbnail images to the Tassie Service. After thumbnails are classified, the original images of those identified as Food Photos are uploaded and stored in our server.|
||If you post recipes or comments|- Any Personal Information included in any of your recipes, comments or other submissions will be collected and processed by Tassie.|
||If you participate in user interviews, surveys or beta testing groups|<p>- We will collect feedback from you about your use of the App and this may include Personal Information.</p><p>- If you help us by completing a user interview then we may collect Personal Information as part of this process which you volunteer as part of the interview.</p>|
||If you contact us|- Name, phone number or email address and any other Personal Information you provide to us in the course of our communication.|
|*Automatically Collected Information*|Technical and Statistical Information|<p>- The internet protocol (IP) address used to connect your computer or device to the internet and geographical location determined from such;</p><p>- Your login information, browser type and version, time zone setting, browser plug-in types and versions, device information such as operating system and platform (as applicable to the device you are using);</p><p>- Information about your visit to our Site, the path that you take through and from our Site (including date and time); pages that you viewed or searched for; page response times, download errors, length of visits to certain pages, page interaction information (such as scrolling, clicks, and mouse-overs), and methods used to browse away from the page; and</p><p>- In the case of our App, information about your use of our App and the country you are connected from.</p>|
|*Special categories of Personal Information*||- Some of the Personal Information that you submit to us about you may be special categories of Personal Information. Special categories of Personal Information include, for example, information relating to allergies (e.g. gluten-free recipes) or religion (e.g. kosher meals). We treat special categories of Personal Information with extra care.|
## **4. Cookies**
We don’t use any kind of cookies in our service.
## **5. How do we use Personal Information collected from you?**
- We, or third-party data processors acting on our behalf, use the Personal Information we collect from you in the following ways: **To provide, develop, maintain, tailor and improve the Tassie Service and any other services that we operate**
- For example, we might use your Personal Information to:
  - verify your identity;
  - allow access to the Site and App;
  - facilitate the access and amendment of registration information;
  - store information about preferences;
  - customise the content on the Site and App in order to provide a more suitable, enriching and improved user experience for you, including the online advertising displayed on the Tassie Service;
  - enable users to participate in competitions and promotions;
  - transmit notices relating to the Tassie Service and deliver prizes and products to you; and
  - ensure security of the Site and App.
- **To conduct analysis and marketing activity**
- For example, we might use your Personal Information to:
  - monitor the number of users using the Site and App in certain geographical locations;
  - monitor use of the Tassie Service in order to understand how it is used and to understand how we can improve the Tassie Service;
  - select participants for user interviews or testing conducted by us or other trusted partners; or
  - provide advertisers, information providers and service providers with information on the types of advertisements and information which can or should be displayed or provided to you through the Tassie Service.
...
We consider that the legal bases for using your Personal Information are as follows:
...
The length of time we retain Personal Information for depends on the purposes for which we collect and use it and/or as required to comply with applicable laws and to establish, exercise of defend our legal rights.
## **10. How do we secure your Personal Information?**
